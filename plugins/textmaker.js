...
Github: https://github.com/Meenakshi/TextMaker-Unlimited
...
Asena.addCommand({pattern: 'textmaker$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    ...
    const msg = command_cmd + '```.textdevil``` \n' + t1 + '_\n' + usage_cmd + '.textdevil Meenakshi_\n\n' +
        command_cmd + '```.textbear``` \n' + desc_cmd + t2 + '_\n' + usage_cmd + '.textbear Meenakshi_\n\n' +
        command_cmd + '```.textwolf``` \n' + desc_cmd + t10 + '_\n' + usage_cmd + '.textwolf Developer;Meenakshi_\n\n' +
        command_cmd + '```.textneon```\n' + desc_cmd + t3 + '_\n' + usage_cmd + '.textneon Meenakshi_\n\n' +
        command_cmd + '```.text2neon``` \n' + desc_cmd + t4 + '_\n' + usage_cmd + '.text2neon Meenakshi_\n\n' +
        command_cmd + '```.text3neon``` \n' + desc_cmd + t18 + '_\n' + usage_cmd + '.text3neon Meenakshi_\n\n' +
        command_cmd + '```.text4neon``` \n' + desc_cmd + t27 + '_\n' + usage_cmd + '.text4neon Meenakshi_\n\n' +
        command_cmd + '```.textlight``` \n' + desc_cmd + t5 + '_\n' + usage_cmd + '.textlight Meenakshi_\n\n' +
        command_cmd + '```.textjoker``` \n' + desc_cmd + t6 + '_\n' + usage_cmd + '.textjoker Meenakshi_\n\n' +
        command_cmd + '```.textninja``` \n' + desc_cmd + t7 + '_\n' + usage_cmd + '.textninja Developer;Meenakshi_\n\n' +
        command_cmd + '```.textglitter``` \n' + desc_cmd + t8 + '_\n' + usage_cmd + '.textglitter Meenakshi_\n\n' +
        command_cmd + '```.textbokeh``` \n' + desc_cmd + t9 + '_\n' + usage_cmd + '.textbokeh Meenakshi_\n\n' +
        command_cmd + '```.textmarvel``` \n' + desc_cmd + t11 + '_\n' + usage_cmd + '.textmarvel Developer;Meenakshi_\n\n' +
        command_cmd + '```.text2marvel``` \n' + desc_cmd + t12 + '_\n' + usage_cmd + '.text2marvel Developer;Meenakshi_\n\n' +
        command_cmd + '```.textavengers``` \n' + desc_cmd + t13 + '_\n' + usage_cmd + '.textavengers Developer;Meenakshi_\n\n' +
        command_cmd + '```.textgraf``` \n' + desc_cmd + t15 + '_\n' + usage_cmd + '.textgraf Developer;Meenakshi_\n\n' +
        command_cmd + '```.text2graf``` \n' + desc_cmd + t16 + '_\n' + usage_cmd + '.text2graf Developer;Meenakshi_\n\n' +       
        command_cmd + '```.textlion``` \n' + desc_cmd + t17 + '_\n' + usage_cmd + '.textlion Developer;Meenakshi_\n\n' +
        command_cmd + '```.textice``` \n' + desc_cmd + t19 + '_\n' + usage_cmd + '.textice Meenakshi_\n\n' +
        command_cmd + '```.textspace``` \n' + desc_cmd + t20 + '_\n' + usage_cmd + '.textspace Developer;Meenakshi_\n\n' +
        command_cmd + '```.textsmoke``` \n' + desc_cmd + t21 + '_\n' + usage_cmd + '.textsmoke Meenakshi_\n\n' + // Thanks for @Unique_hunter for base.
        command_cmd + '```.textglow``` \n' + desc_cmd + t23 + '_\n' + usage_cmd + '.textglow Meenakshi_\n\n' +
        command_cmd + '```.textfire``` \n' + desc_cmd + t25 + '_\n' + usage_cmd + '.textfire Meenakshi_\n\n' +
        command_cmd + '```.textharry``` \n' + desc_cmd + t26 + '_\n' + usage_cmd + '.textharry Meenakshi_\n\n' +
        command_cmd + '```.textcup``` \n' + desc_cmd + t29 + '_\n' + usage_cmd + '.textcup Meenakshi_\n\n' +
        command_cmd + '```.textcemetery``` \n' + desc_cmd + t28 + '_\n' + usage_cmd + '.textcemetery Meenakshi_\n\n' +
        command_cmd + '```.textglitch``` \n' + desc_cmd + t14 + '_\n' + usage_cmd + '.textglitch Developer;Meenakshi_'
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated
jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/ttgra.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-a-cool-graffiti-text-on-the-wall-1010.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/t2gra.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/t2gra.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-lion-logo-mascot-online-938.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/lion.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/lion.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/neon-text-effect-online-963.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/neon3.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/neon3.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/ice-cold-text-effect-862.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/ice.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/ice.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.textpro("https://textpro.me/create-space-3d-text-effect-online-985.html",
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/space.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/space.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/other-design/create-an-easy-smoke-type-effect-390.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/smoke.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/smoke.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/Meenakshi🙋🏻‍♀️Duplicated/glowttp.jpg', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/glowttp.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
    })
}));
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/realistic-flaming-text-effect-online-197.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/tfire.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/tfire.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/create-harry-potter-text-on-horror-background-178.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/hp.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/hp.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/illuminated-metallic-effect-177.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/t4n.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/t4n.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/text-on-scary-cemetery-gate-172.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/cmth.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/cmth.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
    ...
    thiccysapi.photooxy("https://photooxy.com/logo-and-text-effects/put-text-on-the-cup-387.html",
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/Meenakshi🙋🏻‍♀️Duplicated/cup.jpg', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/Meenakshi🙋🏻‍♀️Duplicated/cup.jpg'), MessageType.image, { caption: 'Made by Meenakshi🙋🏻‍♀️' })
              })
          } catch(err) { 
              console.log(err)
          } 
